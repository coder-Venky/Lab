...
<!DOCTYPE html>
<html>
<title>LAB CONTROL SYSTEM</title>
<head>
	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">LAB CONTROL SYSTEM</a>
				<ul class="user-menu">
					...
					<li class="dropdown pull-right notification">
						...
						<ul class="dropdown-menu" role="menu">
							<li>
								<a href="reservation">
									<span id="reserveBadge2" class="today_reservation badge">
									</span> - Today's Reservation
								</a>
							</li>
						</ul>
					</li>
